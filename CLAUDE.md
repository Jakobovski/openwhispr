...
## Current Development Scope (read this first)

Two standing decisions narrow where effort goes on this fork. They don't retract what already exists — the i18n system, the single-provider LLM features, and the 9 non-English locales all still run for whoever has them configured — but they set the priority for new work and for how much polish anything outside them deserves.
